...
type
  ...
  private
    ...
    procedure SystemListMethods(Thread: TRpcThread; const sMethodName: string;
        List: TList; Return: TRpcReturn);
    procedure SystemMethodHelp(Thread: TRpcThread; const sMethodName: string;
        List: TList; Return: TRpcReturn);
    procedure SystemMethodSignature(Thread: TRpcThread;
        const sMethodName: string; List: TList; Return: TRpcReturn);
...
procedure TRpcServer.SystemListMethods(Thread: TRpcThread; const sMethodName: 
...
procedure TRpcServer.SystemMethodHelp(Thread: TRpcThread; const sMethodName: 
    string; List: TList; Return: TRpcReturn);
var
  Data: string;
  Index: Integer;
...
procedure TRpcServer.SystemMethodSignature(Thread: TRpcThread; const
    sMethodName: string; List: TList; Return: TRpcReturn);
var
  S: string;
  RpcArray: IRpcArray;

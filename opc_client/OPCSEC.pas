...
type
  ...
  IOPCSecurityNT = interface(IUnknown)
    ...
    function IsAvailableNT(out pbAvailable : BOOL) : HResult;
      stdcall;
    function QueryMinImpersonationLevel(out pdwMinImpLevel : DWORD) :
      HResult; stdcall;
  ...
  IOPCSecurityPrivate = interface(IUnknown)
    ...
    function IsAvailablePriv(out pbAvailable : BOOL) : HResult;
      stdcall;
    function Logon(szUserID : POleStr;

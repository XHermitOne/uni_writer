...
type
  ...
  IOPCCommon = interface(IUnknown)
    ...
    function SetLocaleID(dwLcid : TLCID) : HResult;
      stdcall;
    function GetLocaleID(out pdwLcid : TLCID) : HResult;
      stdcall;
    ...
    function SetClientName(szName : POleStr) : HResult;
      stdcall;
  end;
  ...
  IOPCShutdown = interface(IUnknown)
    ...
    function ShutdownRequest(szReason : POleStr) : HResult;
      stdcall;
  end;
  ...
  IOPCServerList = interface(IUnknown)
    ...
    function GetClassDetails(const clsid : TCLSID;
      out ppszProgID : POleStr;
      out ppszUserType : POleStr) : HResult; stdcall;
    function CLSIDFromProgID(szProgId : POleStr;
